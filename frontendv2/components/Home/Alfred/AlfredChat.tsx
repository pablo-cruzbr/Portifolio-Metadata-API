...
export default function AlfredChat() {
  ...
  return (
    <section id="alfred" className="bg-[#050709] py-24">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-2 lg:px-8">
            ...
            <div className="flex flex-col gap-2.5">
              {SUGGESTED_QUESTIONS.map((q) => (
                <button
                  ...
                  disabled={isLoading}
                  className="rounded-md border border-white/10 bg-white/2 px-4 py-3 text-left text-[13px] text-[#D7D9E0] transition hover:border-[#5B8DEF]/40 hover:bg-[#5B8DEF]/6 disabled:opacity-40"
                >
                  {q}
                </button>
              ))}
        ...
        {/* Coluna direita — chat */}
        <div data-aos="fade-left" className="flex h-140 flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0A0C12]">
          {/* Header */}
          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto px-5 py-5">
            <div className="flex flex-col gap-4">
              ...
              {isLoading && (
                <div className="flex max-w-[85%] gap-1 rounded-lg bg-white/4 px-4 py-3">
