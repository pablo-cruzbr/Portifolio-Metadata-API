...
function Detalhes() {
  ...
  const project2 = {
    nome: "Meu Apps - Pablo Cruz",
    descricao: "Mestre das comandas foi desenvolvido com React Native versão 1.0.2.",
    descricao2: " Aplicativo feito para gerenciamento de pedidos e comandas para restaurantes ou hamburguerias",
    linkgihub: "https://github.com/seu-usuario",
    linklivedemo: "#", 
    apkPath: "/TechOS-App.apk" 
  };
    ...
    <div className="detalhes-container">
      ...
      <div className="detalhes-card">
        <div className="detalhes-info">
          ...
          <p className="app-title-container">
            <strong> <CiMobile4 size={20}/> Mestre das Comandas - App</strong>
          </p>
          <p>
            <strong>Sobre o Software:</strong>
            <br />
            {project2.descricao}
            <p>{project2.descricao2}</p>
          </p>
            <p className="app-title-container"><strong>Android</strong></p>
          <div className="links">
